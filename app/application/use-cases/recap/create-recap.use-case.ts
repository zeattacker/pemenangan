...
export class CreateRecapUseCase {
  constructor(
    private recapRepository: IRecapRepository,
    private sessionRepository: ISessionRepository
  ) {}

  async execute(recapData: ManageRecapDto, cookieHeader?: string | null) {
    ...
    // voterData.dptId = parseInt(recap.dptId.toString());

    return this.recapRepository.createRecap(recapData, accessToken);
  }
}
